...
export default () => {
    let contactFormElement = useRef(null);
    function clearForm() { contactFormElement.current.reset() }

    return (
        <form ref={contactFormElement} className="contact-me-form" name="contact-me-form" method="post" action="/contact-me/success" data-netlify="true" data-netlify-honeypot="bot-field">
